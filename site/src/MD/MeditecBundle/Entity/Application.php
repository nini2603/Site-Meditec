 ...
 * @ORM\Entity(repositoryClass="MD\MeditecBundle\Repository\ApplicationRepository")
 */
class Application
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="titre", type="string", length=455)
     */
    private $titre;
     ...
     * @var string
     *
     * @ORM\Column(name="chemin1", type="string", length=255)
     */
    private $chemin1;
     ...
     * @var string
     *
     * @ORM\Column(name="chemin2", type="string", length=255)
     */
    private $chemin2;
     ...
     * @var string
     *
     * @ORM\Column(name="chemin3", type="string", length=255)
     */
    private $chemin3;
     ...
     * @var string
     *
     * @ORM\Column(name="chemin4", type="string", length=255)
     */
    private $chemin4;
    ...
    public function getUploadDir()
    {
      ...
      return 'uploads/img_application';
    }
